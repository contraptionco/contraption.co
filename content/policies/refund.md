...
At the end of the day, nearly everything on the edges comes down to a case-by-case basis. [Send us a note](mailto:hello@contraption.co), tell us what's up, and we'll work with you to make sure you’re happy.

**This policy applies to any product created and owned by Contraption Co. LLC. That includes Booklet and Postcard. There are [some nuances with HEY](hey) because its subscriptions are on an annual basis only.*
